        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent I = new Intent(ActivityLogin.this, MenuActivity.class);
                    startActivity(I);
                } else {
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(ActivityLogin.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            ...
                            if (task.isSuccessful()) {
                                Intent I = new Intent(ActivityLogin.this, MainActivityTest.class);
                                startActivity(I);
                                Toast.makeText(ActivityLogin.this, "Not sucessfull", Toast.LENGTH_SHORT).show();
                            } else {

                                Toast.makeText(ActivityLogin.this, "sucessfull", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                } else {
